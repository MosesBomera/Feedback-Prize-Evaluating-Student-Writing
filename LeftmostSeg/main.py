...
if __name__ == "__main__":
    ...
    lexicalVocab, labelVocab = setUpVocab(df)

    # Data loaders. 
    trainLoader = getDataLoader(df, args.batch_size, True)

    # The model.
    model = LeftmostSeg(lexicalVocab, labelVocab, args.word_embedding_dim,
